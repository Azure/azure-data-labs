...
module "synapse_workspace" {
  ...
  adls_id              = local.enable_synapse_workspace ? module.storage_account_syn[0].adls_id : "null"
  storage_account_id   = local.enable_synapse_workspace ? module.storage_account_syn[0].id : "null"
  storage_account_name = local.enable_synapse_workspace ? module.storage_account_syn[0].name : "null"
