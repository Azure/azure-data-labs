...
module "storage_account_syn" {
  ...
  private_dns_zone_ids_blob = [module.private_dns_zones[0].list["privatelink.blob.core.windows.net"].id]
  private_dns_zone_ids_file = [module.private_dns_zones[0].list["privatelink.file.core.windows.net"].id]
